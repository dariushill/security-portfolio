...
# Security Portfolio: Darius Hill
...
|---|-------|-------|----------|
| 1 | Operation Dead Deploy | Governance forensics, deployment audit trail | https://github.com/dariushill/security-portfolio/blob/main/operation%20dead%20deploy.md |
